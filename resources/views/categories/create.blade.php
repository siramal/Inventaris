...
@section('content')
    <div class="bg-white rounded-md shadow-md p-8 min-h-[400px] max-w-3xl">
        ...
        <h2 class="text-xl font-bold text-[#050A30] mb-1">Add Category Forms</h2>
            ...
            <div class="mb-10">
                ...
                <div class="flex relative">
                    ...
                    <select name="division"
                        class="w-full px-4 py-3 border {{ $errors->has('division') ? 'border-red-500' : 'border-gray-200 focus:border-blue-400 focus:ring-1 focus:ring-blue-400' }} rounded-r-md focus:outline-none transition text-gray-700 bg-white appearance-none cursor-pointer">
                        <option value="" disabled {{ old('division') ? '' : 'selected' }}>Select Division PJ</option>
